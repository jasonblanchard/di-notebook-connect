...
import (
	...
	v1 "github.com/jasonblanchard/di-notebook-connect/gen/protobuf/ping/v1"
	http "net/http"
	strings "strings"
)
...
func NewPingServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) PingServiceClient {
	...
	return &pingServiceClient{
		ping: connect_go.NewClient[v1.PingRequest, v1.PingResponse](
			httpClient,
			baseURL+"/protobuf.ping.v1.PingService/Ping",
			opts...,
		),
	}
}
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/protobuf.ping.v1.PingService/Ping", connect_go.NewUnaryHandler(
		"/protobuf.ping.v1.PingService/Ping",
		svc.Ping,
		opts...,
	))
	return "/protobuf.ping.v1.PingService/", mux
}
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("protobuf.ping.v1.PingService.Ping is not implemented"))
}
